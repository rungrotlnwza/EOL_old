            ...
            <div class="col-xs-12" style="padding:0px;margin:0px;">
                <div id="sub_menu"
                    ...
                    <a href="../shop/payment.php" style="padding-right:30px;">•
                        วิธีการสั่งซื้อ</a>
                    <a href="../shop/policy-change-product.php" class="active">•
                ...
                <div style="padding:0px 150px;border:0px solid blue;" class="taviraj">
                    <center>
                        <div id="apDiv69" class="kanit" style="padding-top:20px;">
                            ...
                            <img src="../images/shop/policy-change-product.jpg" width="100%" style="border-radius:10px">
                        </div>
                    </center>
                    <BR><BR>
